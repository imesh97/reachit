...
<head>
    ...
    <title>View Listings - ReachIt</title>
                    ...
                    <div class="col-lg-2">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" onclick="changeCategory('Tools and Hardware');">Tools and Hardware</a>
                                <a class="dropdown-item" onclick="changeCategory('Outdoor and Garden');">Outdoor and Garden</a>
                                <a class="dropdown-item" onclick="changeCategory('Home and Security');">Home and Security</a>
                                <a class="dropdown-item" onclick="changeCategory('Other');">Other</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-1">
